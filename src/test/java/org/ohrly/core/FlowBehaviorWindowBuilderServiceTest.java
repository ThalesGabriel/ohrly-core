...
import org.ohrly.core.services.FlowBehaviorWindowBuilderService;
...
@SpringBootTest
class FlowBehaviorWindowBuilderServiceTest {

    @Autowired
    private FlowBehaviorWindowBuilderService builder;

    @Test
    void shouldBuildBehaviorWindowSummary() {
        var clean = trajectory(
                "s1",
                TrajectoryOutcomeType.COMPLETED,
        ...
        var degraded = trajectory(
                "s2",
                TrajectoryOutcomeType.ABANDONED,
                List.of(
